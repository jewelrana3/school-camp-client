        ...
        <div>
            <Carousel>
                ...
                <div>
                    ...
                    <div className="absolute top-0 flex items-center px-6 md:px-36 inset-0 bg-gray-900 opacity-75">
                        <div className="text-white mx-auto">
                            <h3 className=" text-2xl md:text-3xl md:-ml-6font-semibold mb-4 text-auto"><Fade cascade duration={30}>Experience the Magic of sports Child</Fade></h3>
                ...
                <div>
                    ...
                    <div className="absolute top-0 flex items-center px-8 md:px-36 inset-0 bg-gray-900 opacity-75">
                        <div className="text-white">
                            <h2 className="-ml-3 text-2xl md:text-3xl md:-ml-4 font-semibold mb-4 text-auto"><Fade cascade duration={30}>Football match interest Adventure</Fade></h2>
